...
1. Go to the IDE's plugin manager (File -> Settings -> Plugins) and install
  the following plugins:
   ...
   - [[https://plugins.jetbrains.com/plugin/15976-which-key][Which-Key]]: menu that shows the available commands as you type
   - [[https://plugins.jetbrains.com/plugin/7086-acejump][AceJump]]: quick cursor movement
2. Clone this repository in your home directory:
  #+begin_src sh
  git clone https://github.com/Weiqifan1/intellimacsjumpkeys ~/.intellimacs
  #+end_src
3. In your home directory, create the file =.ideavimrc= and paste the content from the file MAINIDEAVIMRCFILE/.ideavimrc


The original Readme from marcoieni's project:
