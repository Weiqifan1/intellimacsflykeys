#+TITLE: Intellimacsflykeys

This is a modified version of marcoieni's intellimacs. The main focus is to replace most of the VIM bindings with
a modifed version of xah-fly-keys by Xah Lee.
